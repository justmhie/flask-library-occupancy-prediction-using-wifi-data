...
3. Run comparison script: `python scripts/visualize_shap_comparison.py`
...
├── scripts/train_multiple_model_types.py  # Training with SHAP
├── scripts/visualize_shap_comparison.py   # Comparison plots
...
```bash
# Full workflow
python scripts/train_multiple_model_types.py       # Train with SHAP
python scripts/visualize_shap_comparison.py        # Create comparisons
