...
Run from project root: pytest tests/test_shap_integration.py  or  python tests/test_shap_integration.py
"""
import os
import sys

# When run as script, ensure project root is on path and cwd
...
if not models_dir.exists():
    ...
    print("  python scripts/train_multiple_model_types.py")
    exit(1)
