...
Run from project root: pytest tests/test_backend.py  or  python tests/test_backend.py
"""
import os
import sys

# When run as script, ensure cwd is project root so 'all_data_cleaned.csv' is found
